...
Процедура УстановитьПараметрыОтборы()
	Если Не ЗначениеЗаполнено(ТипДоговора) Тогда   ТипДоговора   = Перечисления.ТипДоговора.Товары; КонецЕсли;
...
Процедура ПриОткрытии()
	...
	Если Не ЗначениеЗаполнено(КонецПериода) Тогда  КонецПериода  = КонецМесяца( ТекущаяДата() ); КонецЕсли;
	Если Не ЗначениеЗаполнено(ТипДоговора) Тогда   ТипДоговора   = Перечисления.ТипДоговора.Товары; КонецЕсли;
