...
Процедура ЗаполнитьНачальныеНастройки(Макет = "СоставПоказателей2010Кв") Экспорт
...
Функция ОбновитьВариантыЗаполнения()
	...
	МакетСоставаПоказателей = ЭтотОбъект.ПолучитьМакет("СоставПоказателей2010Кв");
...
Процедура ЗаполнитьСведенияОбОрганизации()
	...
	Если     Месяц(мДатаКонцаПериодаОтчета) = 3 Тогда
		...
		мОтчетПоТруду.Области.ДатаРаздел7.Значение   = Формат(ДобавитьМесяц(мДатаКонцаПериодаОтчета, -12), "ДФ = 'гггг';Л = uk_UA") + " р.";
...
Процедура Расчет()
	...
	мОтчетПоТруду.Области.П9010_1.Значение = мОтчетПоТруду.Области.П9020_1.Значение
											+ мОтчетПоТруду.Области.П9030_1.Значение
											+ мОтчетПоТруду.Области.П9040_1.Значение
											+ мОтчетПоТруду.Области.П9050_1.Значение
											+ мОтчетПоТруду.Области.П9060_1.Значение;
...
Процедура РасчетЗатратНаСодержаниеРабочейСилы() 

	ТаблСреднеспЧисленности = ПроведениеРасчетов.ПолучитьСреднююЧисленность(ДобавитьМесяц(мДатаНачалаПериодаОтчета,-12),КонецГода(ДобавитьМесяц(мДатаНачалаПериодаОтчета,-12)),"ССЧ","КВАРТАЛСНАЧАЛАГОДА",Организация, "ШТАТ");
	мОтчетПоТруду.Области.П9070_1.Значение =  ТаблСреднеспЧисленности[0].Средняя;
...
Процедура ЗаполнитьАвто()  Экспорт
	...
	Если Месяц(мДатаКонцаПериодаОтчета) = 3 Тогда
		РасчетЗатратНаСодержаниеРабочейСилы();	
	КонецЕсли;
...
мСоставПоказателей = "СоставПоказателей2010Кв";
