...
// Процедура - обработчик события при изменении значения
// периодичности представления отчета.
//
Процедура ПолеВыбораПериодичностьПриИзменении(Элемент)

	ИзменитьПериод(0);

КонецПроцедуры // ПолеВыбораПериодичностьПриИзменении()
...
// Заполняем список выбора поля выбора "Представление".
