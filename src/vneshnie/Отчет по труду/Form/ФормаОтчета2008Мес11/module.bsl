...
//
Процедура ЗаполнитьНачальныеНастройки(Макет = "СоставПоказателей2008Мес11") Экспорт
...
Функция ПолучитьТаблицуВариантовЗаполнения(ИмяСтраницыПанели, ПолучитьЭталонную = Ложь)
	...
	Если мСтруктураВариантыЗаполнения.Свойство(ИмяСтраницыПанели, МассивВариантовЗаполненияСтраниц) Тогда
		...
		Иначе
			...
			МакетСоставаПоказателей = ЭтотОбъект.ПолучитьМакет("СоставПоказателей2008Мес11");
...
Процедура Печать(ВидПечати)
	...
	ОбластьПечати = мОтчетПоТруду.ПолучитьОбласть("Отчет1");
	ПечатнаяФорма.Вывести(ОбластьПечати);
...
мСоставПоказателей = "СоставПоказателей2008Мес11";
