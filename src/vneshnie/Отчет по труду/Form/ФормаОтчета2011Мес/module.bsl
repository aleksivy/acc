...
//
Процедура ЗаполнитьНачальныеНастройки(Макет = "СоставПоказателей2011Мес") Экспорт
...
Функция ПолучитьТаблицуВариантовЗаполнения(ИмяСтраницыПанели, ПолучитьЭталонную = Ложь)
	...
	Если мСтруктураВариантыЗаполнения.Свойство(ИмяСтраницыПанели, МассивВариантовЗаполненияСтраниц) Тогда
		...
		Иначе
			...
			МакетСоставаПоказателей = ЭтотОбъект.ПолучитьМакет("СоставПоказателей2011Мес");
...
Процедура ЗаполнитьАвто()   Экспорт
	...
	ТекстСообщения = НСтр("ru='Невозможно автоматически исключать из состава строк 2010 и 2020 сумму задолженности по больничному!';uk='Неможливо автоматично виключати зі складу рядків 2010 та 2030 суму заборгованості по лікарняним!'");
...
мСоставПоказателей = "СоставПоказателей2011Мес";
