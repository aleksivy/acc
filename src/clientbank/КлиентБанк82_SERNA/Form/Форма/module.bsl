...
Процедура ЗаполнитьИзНастроек()
	...
	Организация = НастройкиОбработки.ОрганизацияПоУмолчанию;
	Счет 		= НастройкиОбработки.РасчетныйСчетПоУмолчанию;
...
Процедура ЭкспортПП()
	...
	Для Каждого Строка Из тчЭкспорт Цикл
		...
		НовСтрока.СуммаНДС		= Строка.Сумма * СтавкаНДС / (100 + СтавкаНДС);
