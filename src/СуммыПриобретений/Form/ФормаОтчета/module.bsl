...
Процедура УстановитьПараметрыОтборы()
	...
	УстановитьПараметр(КомпоновщикНастроек, "СписокСчетовИсключений", мсзСчетаИсключения );
КонецПроцедуры

Процедура ПриОткрытии()
	мсзСчетаИсключения = Новый СписокЗначений;
	мсзСчетаИсключения.Добавить( ПланыСчетов.Хозрасчетный.СчетаВБанках );
	мсзСчетаИсключения.Добавить( ПланыСчетов.Хозрасчетный.РасчетыПоВыданнымАвансам );
	мсзСчетаИсключения.Добавить( ПланыСчетов.Хозрасчетный.РасчетыПоПретензиям );
	мсзСчетаИсключения.Добавить( ПланыСчетов.Хозрасчетный.РасчетыСПоставщикамиИПодрядчиками );
